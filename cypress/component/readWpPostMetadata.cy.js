...
describe('readWpPostMetadata().title', () => {
  it('is and empty string when zero parameters are provided.', () => {
    const meta = readWpPostMetadata()
    expect(meta.title).to.equal('')
  })
  it('chooses fallback title when it is the only option.', () => {
    const meta = readWpPostMetadata(null, { title: 'Fallback Title' })
    expect(meta.title).to.equal('Fallback Title')
  })
  it('chooses post title when it is the only option.', () => {
    const meta = readWpPostMetadata({ title: { rendered: 'Post Title' } })
    expect(meta.title).to.equal('Post Title')
  })
  it('chooses Yoast title when it is the only option.', () => {
    const meta = readWpPostMetadata({ yoast_head_json: { title: 'Yoast Title' } })
...
describe('readWpPostMetadata().description', () => {
...
describe('readWpPostMetadata().openGraph', () => {
...
describe('readWpPostMetadata().robots', () => {
...
describe('readWpPostMetadata().twitter', () => {
